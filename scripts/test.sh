...
before="$(shasum "$test_root/home/.zshrc" "$test_root/home/.tmux.conf" "$test_root/home/.config/ghostty/config")"
HOME="$test_root/home" PATH="$test_root/bin:/usr/bin:/bin" \
  "$test_root/home/Projects/terminal-kit/install.sh" --skip-tools >/dev/null
after="$(shasum "$test_root/home/.zshrc" "$test_root/home/.tmux.conf" "$test_root/home/.config/ghostty/config")"
